...
{
    public class HepsiExpressOrderHttpClientHandler : DelegatingHandler
    {
        private readonly IMemoryCache _cache;
        private readonly ApiDefinitions _apiDefinition;

        public HepsiExpressOrderHttpClientHandler(IMemoryCache cache, IOptions<AppSettings> _appSettings)
        {
